...
\NormalTok{fig, ((ax0, ax1), (ax2, ax3)) }\OperatorTok{=}\NormalTok{ plt.subplots(}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{)}

\NormalTok{ax0.plot(xdata, negExp, label}\OperatorTok{=}\StringTok{"{-}exp({-}b*Q)"}\NormalTok{)}
\NormalTok{ax0.set\_title(}\StringTok{"Negative Exponential Utility Curve"}\NormalTok{)}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax0.set\_xticks([])}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax0.set\_yticks([])}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ax0.set\_ylabel(}\StringTok{"U(Q)"}\NormalTok{)}
\NormalTok{ax0.legend()}
\NormalTok{ax0.titlesize }\OperatorTok{=} \DecValTok{10}

\NormalTok{ax1.plot(xdata, quad, label}\OperatorTok{=}\StringTok{"Q {-} b*Q\^{}2"}\NormalTok{)}
\NormalTok{ax1.set\_title(}\StringTok{"Quadratic Utility Curve"}\NormalTok{)}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax1.set\_xticks([])}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax1.set\_yticks([])}
\NormalTok{ax1.legend()}

\NormalTok{ax2.plot(xdata, lin, label}\OperatorTok{=}\StringTok{"a + b*Q"}\NormalTok{)}
\NormalTok{ax2.set\_title(}\StringTok{"Linear Utility Curve"}\NormalTok{)}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax2.set\_yticks([])}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax2.set\_xticks([])}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax2.set\_ylabel(}\StringTok{"U(Q)"}\NormalTok{)}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax2.set\_xlabel(}\StringTok{"Q"}\NormalTok{)}
\NormalTok{ax2.legend()}

\NormalTok{ax3.plot(xdata, narrow\_pow, label}\OperatorTok{=}\StringTok{"(b / (b{-}1))*Q\^{}(1{-}(1/b))"}\NormalTok{)}
\NormalTok{ax3.set\_title(}\StringTok{"Narrow Power Utility Curve"}\NormalTok{)}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax3.set\_yticks([])}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax3.set\_xticks([])}
\NormalTok{temp }\OperatorTok{=}\NormalTok{ ax3.set\_xlabel(}\StringTok{"Q"}\NormalTok{)}
\NormalTok{ax3.legend()}

\ControlFlowTok{for}\NormalTok{ \_ax }\KeywordTok{in}\NormalTok{ [ax0, ax1, ax2, ax3]:}
\NormalTok{    \_ax.spines[}\StringTok{"right"}\NormalTok{].set\_visible(}\VariableTok{False}\NormalTok{)}
\NormalTok{    \_ax.spines[}\StringTok{"top"}\NormalTok{].set\_visible(}\VariableTok{False}\NormalTok{)}
