...
## Time:                        21:33:08   Log-Likelihood:                -1260.8
...
\NormalTok{df\_purchases.reset\_index(inplace}\OperatorTok{=}\VariableTok{True}\NormalTok{, drop}\OperatorTok{=}\VariableTok{True}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-22-1}

Each customer can then be visualised as a complex of observed characteristics along the axes of the principle components in, for example, a two dimensional plane. Furthermore, we can overlay an interpretation on the components by associating group identifiers to portions of the plane.
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-23-1}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-24-1}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-25-1}
